		...
		<div class="col-md-8 col-md-offset-2 col-xs-12">
			<div class="mainheading">
				...
				<div class="row post-top-meta">
					<div class="col-md-2">
						<a href="author.html"><img class="author-thumb" src="{{ asset('storage/'.$Blog->image) }}" alt="Sal"></a>
					</div>
					<div class="col-md-10">
						<a class="link-dark" >{!!$Blog->author!!}</a><a href="#" class="btn follow"></a>
						<span class="author-description">{!!$Blog->title!!}</span>
					
						<span class="post-date">{!!date('D-M-Y', strtotime($Blog->created_at))!!}</span><span class="dot"></span><span class="post-read">6 min read</span>
					</div>
			...
			<img class="featured-image img-fluid" src="{{ asset('storage/'.$Blog->image) }}" alt="">
			<!-- End Featured Image -->
			...
			<div class="card-block">
				...
				<div class="metafooter">
					<div class="wrapfooter">
						...
						<span class="author-meta">
						<span class="post-name"><a href="author.html">aaa</a></span><br/>
						<span class="post-date">aaa</span><span class="dot"></span><span class="post-read"></span>
						</span>
						<span class="post-read-more"><a href="post.html" title="Read Story"><svg class="svgIcon-use" width="25" height="25" viewbox="0 0 25 25"><path d="M19 6c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v14.66h.012c.01.103.045.204.12.285a.5.5 0 0 0 .706.03L12.5 16.85l5.662 4.126a.508.508 0 0 0 .708-.03.5.5 0 0 0 .118-.285H19V6zm-6.838 9.97L7 19.636V6c0-.55.45-1 1-1h9c.55 0 1 .45 1 1v13.637l-5.162-3.668a.49.49 0 0 0-.676 0z" fill-rule="evenodd"></path></svg></a></span>
					</div>
				</div>
